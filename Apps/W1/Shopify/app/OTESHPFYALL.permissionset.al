permissionset 88005 "OTESHPFY-ALL"
{
    Assignable = true;
    Permissions = tabledata "Shpfy Bulk Operation" = RIMD,
        tabledata "Shpfy Catalog" = RIMD,
        tabledata "Shpfy Catalog Price" = RIMD,
        tabledata "Shpfy Company" = RIMD,
        tabledata "Shpfy Company Location" = RIMD,
        tabledata "Shpfy Credit Card Company" = RIMD,
        tabledata "Shpfy Cue" = RIMD,
        tabledata "Shpfy Customer" = RIMD,
        tabledata "Shpfy Customer Address" = RIMD,
        tabledata "Shpfy Customer Template" = RIMD,
        tabledata "Shpfy Data Capture" = RIMD,
        tabledata "Shpfy Dispute" = RIMD,
        tabledata "Shpfy Doc. Link To Doc." = RIMD,
        tabledata "Shpfy Fulfillment Line" = RIMD,
        tabledata "Shpfy FulFillment Order Header" = RIMD,
        tabledata "Shpfy FulFillment Order Line" = RIMD,
        tabledata "Shpfy Gift Card" = RIMD,
        tabledata "Shpfy Initial Import Line" = RIMD,
        tabledata "Shpfy Inventory Item" = RIMD,
        tabledata "Shpfy Invoice Header" = RIMD,
        tabledata "Shpfy Language" = RIMD,
        tabledata "Shpfy Log Entry" = RIMD,
        tabledata "Shpfy Metafield" = RIMD,
        tabledata "Shpfy Order Attribute" = RIMD,
        tabledata "Shpfy Order Disc.Appl." = RIMD,
        tabledata "Shpfy Order Fulfillment" = RIMD,
        tabledata "Shpfy Order Header" = RIMD,
        tabledata "Shpfy Order Line" = RIMD,
        tabledata "Shpfy Order Line Attribute" = RIMD,
        tabledata "Shpfy Order Payment Gateway" = RIMD,
        tabledata "Shpfy Order Risk" = RIMD,
        tabledata "Shpfy Order Shipping Charges" = RIMD,
        tabledata "Shpfy Order Tax Line" = RIMD,
        tabledata "Shpfy Order Transaction" = RIMD,
        tabledata "Shpfy Orders to Import" = RIMD,
        tabledata "Shpfy OTE Item Buffer" = RIMD,
        tabledata "Shpfy Payment Method Mapping" = RIMD,
        tabledata "Shpfy Payment Terms" = RIMD,
        tabledata "Shpfy Payment Transaction" = RIMD,
        tabledata "Shpfy Payout" = RIMD,
        tabledata "Shpfy Product" = RIMD,
        tabledata "Shpfy Province" = RIMD,
        tabledata "Shpfy Refund Header" = RIMD,
        tabledata "Shpfy Refund Line" = RIMD,
        tabledata "Shpfy Refund Shipping Line" = RIMD,
        tabledata "Shpfy Registered Store New" = RIMD,
        tabledata "Shpfy Return Header" = RIMD,
        tabledata "Shpfy Return Line" = RIMD,
        tabledata "Shpfy Sales Channel" = RIMD,
        tabledata "Shpfy Shipment Method Mapping" = RIMD,
        tabledata "Shpfy Shop" = RIMD,
        tabledata "Shpfy Shop Collection Map" = RIMD,
        tabledata "Shpfy Shop Inventory" = RIMD,
        tabledata "Shpfy Shop Location" = RIMD,
        tabledata "Shpfy Skipped Record" = RIMD,
        tabledata "Shpfy Suggest Payment" = RIMD,
        tabledata "Shpfy Synchronization Info" = RIMD,
        tabledata "Shpfy Tag" = RIMD,
        tabledata "Shpfy Tax Area" = RIMD,
        tabledata "Shpfy Templates Warnings" = RIMD,
        tabledata "Shpfy Transaction Gateway" = RIMD,
        tabledata "Shpfy Translation" = RIMD,
        ...
        table "Shpfy Templates Warnings" = X,
        ...
        codeunit "OBC Shpfy Auth Method - Token" = X,
        ...
        codeunit "Shpfy Create Item As Variant" = X,
        ...
        codeunit "Shpfy GQL GetProductOptions" = X,
        ...
        codeunit "Shpfy GQL NextRevFulfillOrders" = X,
        codeunit "Shpfy GQL NextRevFulfillOrdLns" = X,
        ...
        codeunit "Shpfy GQL RevFulfillOrderLines" = X,
        codeunit "Shpfy GQL RevFulfillOrders" = X,
        ...
        codeunit "Shpfy Webhook Notification" = X,
        ...
        tabledata "Shpfy Metafield Value" = RIMD,
        tabledata "Shpfy OTE Setup" = RIMD,
